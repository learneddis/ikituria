...
game.onUpdate(function () {
    ...
    if (Playerstats[1] >= 4) {
        for (let value of Pens) {
            value[1].setPosition(value[0].x, value[0].y)
            value[2].setPosition(value[0].x, value[0].y)
            value[3].setPosition(value[0].x, value[0].y)
            value[4].setPosition(value[0].x, value[0].y)
            value[5].setPosition(value[0].x, value[0].y)
        }
    }
})
